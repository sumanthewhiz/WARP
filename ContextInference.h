...
struct ContextSnapshot
{
    ...
    //
    // Source of truth: when the optional Qwen3-0.6B "brain" model is
    // loaded, these lines are GENERATED BY THE LLM directly from the
    // raw item titles (the cluster->theme algorithmic pipeline runs
